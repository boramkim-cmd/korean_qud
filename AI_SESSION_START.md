...
> **`.github/copilot-instructions.md`로 통합되었습니다.**
> 
> GitHub Copilot은 `.github/copilot-instructions.md`를 자동으로 읽습니다.
> 이 파일은 참조용으로만 보관됩니다. (삭제 예정: 2026-02-01)

---

# 🚨 AI 에이전트 세션 시작 필수 읽기 (LEGACY)
