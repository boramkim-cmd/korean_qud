...
namespace QudKRTranslation.Data
{
    public static class OptionsData
    {
        ...
        private static Dictionary<string, string> baseTranslations = new Dictionary<string, string>()
        {
            ...
            { "ALLOW CREATURES TO HAVE MULTIPLE DEFECTS ", "ALLOW CREATURES TO HAVE MULTIPLE DEFECTS " },
            ...
            { "ALLOW SCRIPTING MODS (SCRIPTING MODS MAY CONTAIN MALICIOUS CODE!)", "스크립트 모드 허용 (스크립트 모드는 악성 코드를 포함할 수 있습니다!)" },
            ...
            { "DRAW CREATURE PATHFINDING ", "DRAW CREATURE PATHFINDING " },
