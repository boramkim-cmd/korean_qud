/*
 * 파일명: 00_16_TranslationDB_Inventory.cs
 * 분류: [System] 번역 데이터베이스 - 인벤토리
 * 역할: 인벤토리 및 장비 화면의 UI 텍스트 번역
 */
...
namespace QudKRContent
{
    public static partial class DictDB
    {
        public static Dictionary<string, string> Inventory = new Dictionary<string, string>()
        {
            ...
            { "INVENTORY", "인벤토리" }, { "EQUIPMENT", "장비" },
            { "Nearby", "주변" }, { "Weight", "무게" },
            { "Value", "가치" }, { "Category", "분류" },
            
            // 추가 인벤토리 관련
            { "Equipped", "장착됨" }, { "Unequipped", "장착 해제됨" },
            { "Dropped", "버림" }, { "Picked up", "주움" },
            { "Use", "사용" }, { "Drop", "버리기" },
            { "Equip", "장착" }, { "Unequip", "해제" },
            { "Examine", "조사" }, { "Take", "가져가기" },
            { "Take All", "모두 가져가기" },
            
            // 카테고리
            { "Weapons", "무기" }, { "Armor", "방어구" },
            { "Food", "음식" }, { "Medicine", "약품" },
            { "Books", "책" }, { "Tools", "도구" },
            { "Artifacts", "유물" }, { "Junk", "잡동사니" },

            // 인벤토리 UI 고유 (ScreenBuffer)
            { "[ {{W|Inventory}} ]", "[ {{W|인벤토리}} ]" },
            { "[ {{W|Equipment}} ]", "[ {{W|장비}} ]" },
            ...
            // Inventory Modes & Options
            { "Paperdoll", "인형" }, { "List", "목록" },
            { "Strict", "정확" }, { "Fuzzy", "유사" },
            ...
            { "Head", "머리" }, { "Face", "얼굴" },
            { "Body", "몸통" }, { "Back", "등" },
            { "Missile Weapon", "원거리 무기" }, { "Thrown Weapon", "투척 무기" },
            { "Floating Nearby", "주변 부유" },
            { "Forefeet", "앞다리" }, { "Hindfeet", "뒷다리" },
            { "Left Arm", "왼팔" }, { "Right Arm", "오른팔" },
            { "Left Foot", "왼발" }, { "Right Foot", "오른발" },
            { "Feet", "발" }, { "Hands", "손" },
            { "Roots", "뿌리" }, { "Tail", "꼬리" },
            { "Pseudopod", "위족" }, { "Hardpoint", "하드포인트" },
            { "Ammo", "탄약" },
            { "Foot", "발" }, { "Arm", "팔" },
            { "Leg", "다리" },
            { "Primary Limb", "주 수지" },
            ...
            // Toggle Display Strings (Dynamic Parts)
