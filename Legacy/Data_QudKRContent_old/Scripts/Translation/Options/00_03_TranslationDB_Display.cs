/*
 * 파일명: 00_03_TranslationDB_Display.cs
 * 분류: [System] 번역 데이터베이스 - 디스플레이
 * 역할: 디스플레이 관련 설정 옵션 번역
 */
...
namespace QudKRContent
{
    ...
    {
        // Display 카테고리
        public static Dictionary<string, string> Options_Display = new Dictionary<string, string>()
        {
            // 메인 카테고리 (모든 변형 포함)
            { "Display", "디스플레이" },
            { "DISPLAY", "디스플레이" },
