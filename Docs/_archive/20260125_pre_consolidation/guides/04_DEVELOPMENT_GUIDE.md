...
> [!IMPORTANT]
> **AI 에이전트**: 이 문서를 읽기 전에 반드시 `01_PRINCIPLES.md`를 먼저 읽으세요!
> ```bash
> cat Docs/guides/01_PRINCIPLES.md  # 필수! 대원칙 문서
> ```

이 문서는 상세 개발 가이드입니다. 대원칙과 필수 규칙은 `01_PRINCIPLES.md`에 있습니다.

### 핵심 문서 4종
| 문서                        | 용도                           | 업데이트 주기 |
| --------------------------- | ------------------------------ | ------------- |
| **04_DEVELOPMENT_GUIDE.md** | 개발 참조 가이드 (이 문서)     | 구조 변경 시  |
| **01_TODO.md**              | 작업 추적 (할 일/진행 중/완료) | 작업 시마다   |
| **02_CHANGELOG.md**         | 완료된 작업 기록               | Phase 완료 시 |
| **03_ERROR_LOG.md**         | 에러/이슈 추적 및 해결 기록    | 이슈 발생 시  |

### 문서 연동 구조
```
04_DEVELOPMENT_GUIDE.md (참조 - 불변)
          ↓
01_TODO.md (동적 추적)
          ↓
02_CHANGELOG.md (완료 기록)
          ↓
03_ERROR_LOG.md (에러/이슈 기록)
```
...
> [!IMPORTANT]
> **대원칙은 `01_PRINCIPLES.md`에 통합되었습니다.**
>
> 이 섹션은 `01_PRINCIPLES.md`를 참조하세요:
> - 7대 대원칙
> - 절대 금지 사항
> - 작업 시작 전 체크리스트
> - 문서 업데이트 규칙
